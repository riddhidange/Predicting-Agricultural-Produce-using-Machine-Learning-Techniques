...
function examplesBaggingWithReplacement(
  ...
  return {
    X: new Matrix__default['default'](Xr),
    y: yr,
    Xoob: new Matrix__default['default'](Xoob),
    ioob,
    seed: engine.next(),
  };
}
...
function featureBagging(trainingSet, n, replacement, seed) {
  ...
  let toRet = new Matrix__default['default'](trainingSet.rows, n);
...
class RandomForestBase {
  ...
  train(trainingSet, trainingValues) {
    ...
    for (let i = 0; i < this.nEstimators; ++i) {
      ...
      if (!this.noOOB && this.useSampleBagging) {
        let xoob = new Matrix.MatrixColumnSelectionView(Xoob, this.indexes[i]);
        oobResults[i] = {
          index: ioob,
  ...
  predictionValues(toPredict) {
    ...
    return (predictionValues = new Matrix.MatrixTransposeView(
